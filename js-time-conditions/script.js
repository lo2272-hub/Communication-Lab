...
function buttonClicked() {
    console.log("hello");
    // output.innerText ="I don't want to go to school";
...
inputBox.addEventListener("input", inputChange)

function inputChange(eventInfo) {
    // console.log(eventInfo);

    let text = eventInfo.target.value; //inputBox.value also works

    //check if the value is spain
    if (text == "spin") {
