...
This is the first website that I have built in my life. It’s totally a new experience for me so I feel quite happy to see the result. Looking back at the process, I encountered difficulties and tried to solve them by either seeking help from my professor or trying to work out them on my own. Compared my final work with the project proposal, I changed a lot, but still kept the connection with the website I chose at the beginning. (Ignore Starbucks :P ) Considering that Amazon is an online shopping website, my idea should be associated with either searching for products or purchasing items. At first, I was inspired by the “Best Sellers” category of Amazon and thought maybe I can do the “Worst Sellers” to give my viewers a surprise. However, after doing research, I found that  it was hard for me to identify the lowest rating products as well as there was no credibility for the data. I had to give up my original idea and think about something more accessible. Then I came up with my final idea to build a website for some funny products and interesting stories. Fortunately, the data became easier to find. When I searched for these funny products, I didn’t  feel bored, but more motivated. Meanwhile, when I thought about the name of my website, I noticed that I can replace the “o” character in Amazon with a smiling face which matches with my concept to make people feel happy and laugh out loud. 

- Parts Work Well & Parts Less Satisfied with

I think the introduction pages of these funny products work well, because they are very easy to interact with. Additionally, if the viewers pay attention to the texts, they will find these products are absurd and they might start to smile out of control. **However**, I think the transition from the homepage of Amazon to my own page is interesting but not that effective. Because for people who are not familiar with Amazon, they don’t know why the 404 page has an animal on it, and they might feel confused about what is going on for the next step. I want to improve the parts that need explanations or instructions for the audiences to release their confusion.

**Reflection on feedback**

I really enjoyed hearing feedback from others who are new to my website since people view things differently, I’m willing to make adaptations based on sincere feedback. 
Based on the feedback from the **Interaction Day**, I made three changes.
- I removed the hover effect which I thought was good and fancy for the unclickable part. However,one of my testers said this effect will make people feel confused because they tend to think these parts are clickable but they receive no response. 
- I also changed the long paragraph texts into some single words. This change not only arouses people’s interest, but also becomes more readable for people to get the central idea. 
- The third change I made was to change the unnecessary screenshots to codes, even in less important parts of my website. As professor Leon said, even though they are not the points of your project, through the coding process, they help you to understand the structure and working principle of HTML and CSS more. 

After hearing the **presentation’s feedback**, I realized that my concept was not surprising enough, and some parts of my project have too much content which is very easy to overwhelm the viewers. If I have the chance to work on it further, I would like to improve these two parts – the concept and the way of delivering the content.
- For the concept, I think professor Moon provided a good starting point for further exploration. I agree with the idea that maybe I can focus on the purchase function of the online shopping website. For example, I can sell things that do not exist in real life or things people think are untradable such as emotions. However, I still need to find a way to transit from the original website to my own website.
- For the way of delivering the content, I think the best way is to reduce the text and change them into bigger sizes or different colors. In addition, I will increase the spacing between sections and group related content into separate blocks, which can make the layout cleaner. I hope these changes will help users quickly identify the most important content and improve the overall reading experience.


## Credits & References
- Ad and product images are sourced from [Amazon](https://www.amazon.com/) for reference.
- Some review images are generated by [ChatGPT](https://chat.chatbot.app/gpt5?utm_source=GoogleAds&utm_medium=cpc&utm_campaign={campaign}&utm_id=23302972001&utm_term=189813945752&utm_content=800039943773&gad_source=1&gad_campaignid=23302972001&gbraid=0AAAAA_a6ETu1h5Jy1CIVMHzUKE2XJop-Y&gclid=CjwKCAjwjtTNBhB0EiwAuswYhmURzyibeqw9m4T5MRZ3rbbyeibFY5RBBKSq-43UrdDiihHkCPSBZRoC0_sQAvD_BwE) and [Lovart](https://www.lovart.ai/zh/home)
